...
public class ErrorMsg {
    public static final String SPECIALITY_ERROR_MSG = "You should provide at least one speciality";

    public static final String AVAILABILITY_ERROR_MSG = "You should provide either NOW or SOON for availability";
    public static final String ROLE_ERROR_MSG = "role can not be blank";
    public static final String YEARS_OF_EXPERIENCE_ERROR_MSG = "should be between 0 and 99 included";
    public static final String CAN_NOT_BE_BLANK_ERROR_MSG = "can not be blank";
